-- crie uma procedure que retorne o nome do cliente, a quantidade de pedidos e o total de vendas do cliente por ano
...
call sp_resumo_cliente (282, 2004)

-- crie uma trigger para atualizar o estoque após um insert em orderdetails
...
-- Crie uma function que devolva o valor total do pedido
...
-- Teste
SELECT fn_total_pedido(10102) AS valor_total;

-- criar view para ver faturamento anual do cliente
